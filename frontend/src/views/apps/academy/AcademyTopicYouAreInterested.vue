...
const topicsChartConfig = {
  ...
  labels: ['Борщевик сосновского', 'Амброзия', 'Пластик', 'Жужелица', 'Бяка', 'Саранча',],
...
const topicsData = [
  { title: 'Борщевик сосновского', value: 35, color: 'primary' },
  { title: 'Амброзия', value: 20, color: 'info' },
  { title: 'Пластиковые бутылки', value: 14, color: 'success' },
  { title: 'Жужелица кровоногая', value: 12, color: 'secondary' },
  // { title: 'Бяка всякая', value: 10, color: 'error' },
  // { title: 'Саранча', value: 9, color: 'warning' },
]
</script>

<template>
  <VCard>
    <VCardItem title="Реагирование моделей на пожары">
      <template #append>
        <MoreBtn />
      </template>
    </VCardItem>
