...
const headers = [
  { title: 'Область исследования', key: 'courseName' },
  { title: 'Время', key: 'time', sortable: false },
  { title: 'Степень загрязнения', key: 'progress' },
  { title: 'Маркеры', key: 'status', sortable: false },
]
  ...
  <VCard>
      ...
      <div class="d-flex flex-wrap justify-space-between align-center gap-4">
        <h5 class="text-h5 font-weight-medium">
          Результаты исследований снимков
        </h5>
        <div>
          <AppTextField
            v-model="searchQuery"
